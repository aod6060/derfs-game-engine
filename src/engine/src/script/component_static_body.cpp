...
namespace script {
    ...
    void manager_component_static_body_load_library(lua_State* l) {
        ...
        lua_register(l, "manager_component_static_body_hasComponent", manager_component_static_body_hasComponent);
        // int manager_component_static_body_getComponent(lua_State* l);
        lua_register(l, "manager_component_static_body_getComponent", manager_component_static_body_getComponent);
    }
